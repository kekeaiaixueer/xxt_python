...
北京时间2026年7月15日编辑
当前版本bug过多已经学习通更新了新的人脸逻辑处理已经防盗图处理功能过多这边准备重新写一个版本后续会发布新版本应该大概是下学期左右会换成webui的模式方便小白用户，多用户在新的版本里面应该是支持的吧应该吧，顺便会处理下二维码获取逻辑，之前部分用户会出现获取不到签到的问题目之前修复过一次但是还是有用户收不到目前不知道什么原因。
